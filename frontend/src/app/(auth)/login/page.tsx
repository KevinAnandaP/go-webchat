  ...
  return (
    <div className="w-full max-w-sm animate-slideUp">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-[var(--text-tertiary)] mt-1">Sign in to continue chatting</p>
      </div>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-[var(--border-light)] text-[var(--accent-blue)] focus:ring-[var(--accent-blue)]"
              />
